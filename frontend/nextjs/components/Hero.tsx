    ...
    <div className="relative overflow-visible min-h-[80vh] sm:min-h-[85vh] flex items-center pt-[60px] sm:pt-[80px] mt-[-60px] sm:mt-[-130px]">
      ...
      >
        ...
        >
          ...
          >
            <div className="mb-2 xs:mb-3 sm:mb-1 md:mb-0 text-blue-900">學術知識蒐集系統</div>
            <span
              style={{
                backgroundImage: 'linear-gradient(to right, #1e40af, #3b82f6, #60a5fa)',
          ...
          <motion.h2 
            className="text-base sm:text-xl font-medium text-center px-4 mb-6 text-gray-700 max-w-2xl"
            variants={fadeInUp}
            transition={{ duration: 0.8, delay: 0.6 }}
          >
            YCM 研究助理為您提供全方位的學術資源蒐集、分析與整合，大幅提升研究效率與質量
          </motion.h2>
          ...
          >
            YCM Deep Researcher Version 2.0
          </motion.div>
